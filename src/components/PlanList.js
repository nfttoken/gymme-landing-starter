...
const PlanList = ({ plans }) => {
  ...
  return (
    <div className="flex flex-col lg:flex-row items-center justify-center max-w-[1024px] mx-auto gap-y-4 ">
            ...
            >
              ...
              <div className="flex flex-row lg:flex-col gap-x-8 gap-y-8 lg:gap-x-0 items-center">
                <div>
                  ...
                  <div className="text-[30px] lg:text-[40px] font-primary font-semibold text-center flex flex-col items-center justify-center">
