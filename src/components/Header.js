...
const Header = () => {
  ...
  return (
    <header
      ...
      } fixed max-w-[1440px] z-30 left-0 right-0 flex mx-auto justify-between items-center px-[20px] lg:px-[80px] transition-all duration-300`}
    >
      {/*logo*/}
      <a href="">
      ...
      <div className="hidden lg:flex space-x-4">
        ...
        <button className="btn btn-sm text-primary-200">{btnSignupText}</button>
      </div>
